...
let h1e = document.querySelector('.heroslider__caption');
let h1 = document.querySelector('.heroslider__caption').innerHTML;
let arr = h1.split(" ");
...
if(arr.length<=2){
    h1e.innerHTML=`${one} <span class="heroslider__caption-span">${two}</span>`;
}
else{
    h1e.innerHTML=`${one} <span class="heroslider__caption-span">${two}</span>`;
}
...
class MainNavigation {
 constructor({
    ...
    mainTriggerActiveClass : mainTriggerActiveClass,
 ...
 }) 
 {
     ...
     this.mainTriggerActiveClass = mainTriggerActiveClass;
...
mainNavigationTrigger(){
 ...
 this.mainTrigger.addEventListener("click", (e)=>{
         ...
         if(window.innerWidth>=this.breakPoint) {
             ...
             e.currentTarget.classList.toggle(this.mainTriggerActiveClass);
...
let MainNavigationOne = new MainNavigation({
 ...
 mainTriggerActiveClass : 'main-nav__trigger--active',
...
navLink.forEach((item)=>{
 item.classList.add("main-nav__link");
})
