...
<div id="splide1" class="splide heroslider">
<div class="heroslider__caption-wrapper">
  <div class="heroslider__caption-content">
  <h2 class="heroslider__caption">
<?php echo carbon_get_the_post_meta('text1') ?>
</h2>
<div class="heroslider__description">
  <a href="<?php echo carbon_get_the_post_meta('herosliderlink') ?>" class="btn btn1">More</a>
  <p class="heroslider__description-text">Zawafi provide premium range of Interior design solutions in Dubai</p>
</div>
  </div>
  ...
  <div class="splide__track">
    <ul class="splide__list">
      <?php
$herosliders = carbon_get_the_post_meta( 'heroslider' ); 
foreach ( $herosliders as $heroslider ) {
?>
<li class="splide__slide">
<img src="<?php echo $heroslider['product-image'] ?>" width="1366" height="625" class="heroslider__image" />
</li>	
<?php
}	
?>
...
<main class="site-content__section products-in-home">
<div class="container">

<div class="products-in-home__container">
<?php
$servicecategories = carbon_get_the_post_meta( 'servicecategories' ); 
...
<h2 class="h2 home-introduction__heading"><?php echo carbon_get_the_post_meta( 'introduction-title' ); ?></h2>
  <p class="home-introduction__description text-center"><?php echo carbon_get_the_post_meta('introduction-description') ?></p>
    <div class="home-introduction__btn btn-wrapper text-center">  
        <a href="<?php echo carbon_get_the_post_meta('introduction-link') ?>" class="btn btn1">More</a>
      </div>
</div>
...
<?php
$sectionloop = carbon_get_the_post_meta( 'sectionloop' ); 
...
<div class="site-content__section home-profile">
  <img src="<?php echo carbon_get_the_post_meta('home-profile-image');?>" class="home-profile__bg-image" alt="home-profile" >
  <div class="container home-profile__container">
    <div class="home-profile__content">
      <h2 class="home-profile__heading"><?php echo carbon_get_the_post_meta( 'home-profile-title' ); ?></h2>
      <p class="home-profile__description"><?php echo carbon_get_the_post_meta( 'home-profile-description' ); ?></p>
      <a href="" class="btn btn1">More</a>
    </div>
  </div>
</div>

				
<div class="site-content__section home-custom">
  <div class="home-custom__container container">
    <div class="home-custom__col1">
      <img src="<?php echo carbon_get_the_post_meta('home-custom-image');?>" class="home-custom__image" alt="">
    </div>
    <div class="home-custom__col2">
    <h2 class="home-custom__heading"><?php echo carbon_get_the_post_meta( 'home-custom-title' ); ?></h2>
      <p class="home-custom__description"><?php echo carbon_get_the_post_meta( 'home-custom-description' ); ?></p>
      <div class="home-custom__points">
      <?php echo carbon_get_the_post_meta( 'home-custom-points' ); ?>
      </div>
      <a href="" class="btn btn1">More</a>
    </div>
  </div>
...
<div class="site-content__section clients">
  <div class="container clients__container">
    <h2 class="clients__heading">Our Clients</h2>
    <div class="clients__list-block">
        <?php
        $clients = carbon_get_the_post_meta( 'clients' ); 
        foreach ( $clients as $client ) {
        ?>
      <a href="<?php echo $client['clients-link'] ?>" target="_blank" class="clients__list-item">
        <img src="<?php echo $client['clients-logos'] ?>" alt="sdfsdf" class="clients__logo-image">
      </a>
      <?php
        }	
      ?>
...
/* Senetence Color Change: Start */


/* Senetence Color Change: End */
...
new Splide( '.heroslider', {
    classes: {
     ...
     arrows: 'heroslider__arrows',
     arrow : 'heroslider__arrow',
     prev  : 'heroslider__prev',
     next  : 'heroslider__next',	
    },
    arrows: false,
     type   : 'loop',
     autoplay    : true,
