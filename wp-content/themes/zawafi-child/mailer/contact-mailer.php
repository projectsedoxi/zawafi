...
//Server settings
    ...
    $mail->addAddress('mail@abc.com', 'abc'); // Add a recipient
    ...
    //$mail->addBCC('bcc@example.com');
				...
				//Recipients
    $mail->setFrom('mail@zawafi.com', 'Zawafi Interiors');
    $mail->addAddress('renjith_nk@yahoo.com', 'Ren Yahoo'); // Add a recipient
    //$mail->addAddress('ellen@example.com');                // Name is optional
    //$mail->addReplyTo('info@example.com', 'Information');
    //$mail->addCC('cc@example.com');
    //$mail->addBCC('bcc@example.com');
