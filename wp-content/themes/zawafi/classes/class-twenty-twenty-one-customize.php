...
if ( ! class_exists( 'zawafi_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Twenty Twenty-One 1.0
	 */
	class zawafi_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'zawafi' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'zawafi' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'zawafi' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'zawafi' ),
						'full'    => esc_html__( 'Full text', 'zawafi' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'zawafi_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new zawafi_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'zawafi' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
